...
public class MyTv {
	...
	public void setVolume(int volume) {
	  ...
	  if (!isPowerOn || volume > MAX_VOLUME || volume < MIN_VOLUME) {
	    return;
	  }
	...
	public void setChannel(int channel) {
		...
		if (!isPowerOn || channel > MAX_CHANNEL || channel < MIN_CHANNEL) {
	    return;
	  }
	...
	public String toString() {
	  return "MyTv [파워 = " + isPowerOn + ", 채널 = " + channel + ", 볼륨 = " 
			  + volume + ", 이전 채널 = " + prevChannel + "]";
	}
}

...
// 	System.out.println("==================tableDB :"+tableDB[0].getCcontents()+"============");
// 	request.setAttribute("tableDB", tableDB[0].getCcontents());
// 	session.setAttribute("tableDB", tableDB[0].getCcontents());
